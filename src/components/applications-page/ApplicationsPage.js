  ...
  function loadApplicationsHandler() {
    ...
    if (!isFiltered) {
      data.getApplications(
        showApplications,
        "&skip=" + index + "&max=" + applicationsShown + "&totals=true",
        setPending
      );
    } else {
      data.getApplications(
      ...
      <section className={styles.topSection}>
        ...
        <section className={`${styles.paragraphWrapper}`}>
          <div className={styles.filler}>
            ...
            <p className={styles.paragraph + " light-text"}>
              {text.paragraph1}
            </p>
            <p className={styles.paragraph + " light-text"}>
              {text.paragraph2}
      ...
      <article className={styles.page}>
        <section className={styles.applicationsWrapper}>
          ...
          {shownApplications.length <= 0 && !pending && (
            <h2 className={styles.noApplicationsText + " display-4"}>
          ...
          {shownApplications.length !== total && (
            <button
              ...
              id={styles.loadingBtn}
              onClick={loadApplicationsHandler}
            >
              Load more...
            </button>
          )}
