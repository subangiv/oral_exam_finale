        ...
        <section className={styles.applicationCardTop}>
          <div className={styles.applicationCardWrapper}>
            <div className={styles.applicationCardImageWrapper}>
              <img
                className={styles.applicationCardImage}
                src={
                  "https://exampollopollo-e360.restdb.io/media/" +
                  props.applicant[0].image[0]
                }
                alt=""
              />
              {flags.getFlag(
                props.applicant[0].country,
                styles.applicationCardFlag
              )}
            </div>
            <section className={styles.applicationCardInfo}>
              <hgroup className={styles.applicationCardHeading}>
                <h2 className={"display-4 " + styles.applicationCardTitle}>
                  {props.product[0].title}
                </h2>
                <h3 className={"display-5"}>
                  {props.applicant[0].first_name +
                    " " +
                    props.applicant[0].last_name}
                </h3>
              </hgroup>
